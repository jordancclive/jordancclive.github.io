...
<center>
  <object type="image/svg+xml" data="./AverageNumberOfCallsPerStudent.svg" type="image/svg+xml"></object>
  <br />
  <br />
...
<center>
   <object type="image/svg+xml" data="./AverageNoOfCallsPerStudentPerMonth.svg" type="image/svg+xml"></object>
</center>
...
<center>
   <object type="image/svg+xml" data="./PercentageIncreaseInNoCallsPerMonth.svg" type="image/svg+xml"></object>
</center>
...
<center>
  <object type="image/svg+xml" data="./BookingsAndCallsPerDayOfTheWeekAugToMay.svg" type="image/svg+xml"></object><br /><br />
...
<center>
  <object type="image/svg+xml" data="./WomenBookFewerCallsWithMeOnAverageThanMen.svg" type="image/svg+xml"></object><br /><br />
</center>
