...
The visual is limited by being two dimensional. Networks are not. It's difficult to visualize the exponential component of improving one's networking pool. In reality, the separate clusters will be *larger* and have *more* interconnectedness among them.
