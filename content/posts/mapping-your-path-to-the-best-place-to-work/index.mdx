...
<center>
  <div className="scroll">
    <img src="https://i.imgur.com/vprICqV.png" width="750px" height="auto" />
  </div>
</center>
...
1. Qualifications are increasingly easy to gain online
2. Globalization is drastically leveling the playing field
3. Technology is automating commodity jobs (the ones people usually take when they're not in control of their life)
4. The dollar value of commodity jobs is shrinking as they're automated or filled with qualified people in the lowest-compensating areas
5. Qualified candidates are getting matched to work openings evermore efficiently

And for those of us benefiting from US passports, the workplace meritocracy will feel more real than ever once the US dollar loses its global reserve currency status and the corporate map will be more geographically distributed.

It's usually impossible to define your ultimate success early on. You'll likely need to adopt an "emergent strategy" as outlined in the book "How Will You Measure Your Life?" (which could be re-titled "How to Find Your Ikigai"). I've published a Facebook post summary of that book <a href="/how-will-you-measure-your-life-the-condensed-version">here</a>.

Nowhere will you build the most meaningful working relationships than among your teammates - that is your primary networking pool. You need to position yourself in the right networking pools to navigate to the best work opportunities.
...
The reason graduates of top MBA programs say their MBAs were worth the exhorbitant tuition costs (to learn things they say are best learned on the job) is because of the network they gained from them. My dad and one of my brothers went to top-5 MBA programs. This is precisely the reason why *anyone* should be fighting hard to position themselves among the best network for their aims. Here is what joining the right team for you looks like. Not only are these teammates the precise people you want to forge long-term relationships with, but they can plug you right into the networks of people that you will want to work with, as well.
...
For each of these five points, there are things you can do for *immediate* results and *more important* things you can do that take time.
